...
```{r exec-log, results="asis"}
txt = c("* 1111","* 222 `aaaaaaa` xyz","* 333")
writeLines(txt)
```
...
```{r long-line}
x= "abc  dddd eee fff ggg hhhh iiiiiiiiiii  jjjjjj kkkkk llllll mmmmm nnnnnn ooooo ppppp qqqqq"
y =x
x
y
```
